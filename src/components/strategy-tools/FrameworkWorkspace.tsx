              ...
              <div className="max-w-[900px] mx-auto px-8 pb-8">
                <div className="bg-card rounded-2xl p-6 border border-border shadow-xl">
                  ...
                  <div className="grid grid-cols-4 gap-3">
                    {/* Card 1 */}
                    <button className="group flex flex-col items-center gap-3 p-6 rounded-xl bg-background border border-border hover:border-primary/40 hover:shadow-md transition-all">
